...
-- 이력서 테이블
insert into resume_tb(user_id, title, area, edu, career, introduce, port_link,  created_at) values (1, '능력있고 성실한 개발자!', '판교분당', '고졸', '미들(4~8년)', '열심히 일하는 개발자가 되겠습니다.', 'naver.com/superjjangcoding',now());
insert into resume_tb(user_id, title, area, edu, career, introduce, port_link, created_at) values (2, '신입 개발자 지원합니다', '서울', '고졸', '신입', '안녕하십니까. 엄격한 아버지와 자상한 어머니의 밑에서 자라나 20대가 된 저는', 'nate.com/gugu',now());
insert into resume_tb(user_id, title, area, edu, career, introduce, port_link, created_at) values (3, '이력서 입니다.', '부산', '대졸', '시니어(10년 이상)', '팀장으로 근무했었고 코딩은 자신있습니다.', 'naver.com/codingsin',now());
insert into resume_tb(user_id, title, area, edu, career, introduce, port_link, created_at) values (4, '이력서 입니다2.', '부산', '대졸', '시니어(10년 이상)', '팀장으로 근무했었고 코딩은 자신있습니다.', 'naver.com/codingsin',now());
insert into resume_tb(user_id, title, area, edu, career, introduce, port_link, created_at) values (5, '이력서 입니다2.', '부산', '대졸', '시니어(10년 이상)', '팀장으로 근무했었고 코딩은 자신있습니다.', 'naver.com/codingsin',now());
insert into resume_tb(user_id, title, area, edu, career, introduce, port_link, created_at) values (6, '이력서 입니다2.', '부산', '대졸', '시니어(10년 이상)', '팀장으로 근무했었고 코딩은 자신있습니다.', 'naver.com/codingsin',now());
insert into resume_tb(user_id, title, area, edu, career, introduce, port_link, created_at) values (7, '이력서 입니다2.', '부산', '대졸', '시니어(10년 이상)', '팀장으로 근무했었고 코딩은 자신있습니다.', 'naver.com/codingsin',now());
insert into resume_tb(user_id, title, area, edu, career, introduce, port_link, created_at) values (4, '이력서 입니다2.', '부산', '대졸', '시니어(10년 이상)', '팀장으로 근무했었고 코딩은 자신있습니다.', 'naver.com/codingsin',now());
insert into resume_tb(user_id, title, area, edu, career, introduce, port_link, created_at) values (6, '이력서 입니다2.', '부산', '대졸', '시니어(10년 이상)', '팀장으로 근무했었고 코딩은 자신있습니다.', 'naver.com/codingsin',now());
insert into resume_tb(user_id, title, area, edu, career, introduce, port_link, created_at) values (1, '이력서 입니다2.', '부산', '대졸', '시니어(10년 이상)', '팀장으로 근무했었고 코딩은 자신있습니다.', 'naver.com/codingsin',now());
insert into resume_tb(user_id, title, area, edu, career, introduce, port_link, created_at) values (4, '이력서 입니다2.', '부산', '대졸', '시니어(10년 이상)', '팀장으로 근무했었고 코딩은 자신있습니다.', 'naver.com/codingsin',now());
...
insert into skill_tb (resume_id, name, role) values(6, 'Jquery', 1);
insert into skill_tb (resume_id, name, role) values(6, 'JavaScript', 1);
...
insert into scrap_tb(user_id, resume_id, created_at) values(5, 4, now());
...
insert into offer_tb(resume_id, jobs_id, status, created_at) values(2,1,1,now());
insert into offer_tb(resume_id, jobs_id, status, created_at) values(3,2,1,now());
insert into offer_tb(resume_id, jobs_id, status, created_at) values(4,2,1,now());
insert into offer_tb(resume_id, jobs_id, status, created_at) values(5,3,1,now());
insert into offer_tb(resume_id, jobs_id, status, created_at) values(6,3,1,now());