...
insert into apply_tb(resume_id, jobs_id, is_pass, created_at) values(1,1,'불합격',now());
insert into apply_tb(resume_id, jobs_id, is_pass, created_at) values(2,1,'대기중',now());
insert into apply_tb(resume_id, jobs_id, is_pass, created_at) values(1,2,'합격',now());

insert into apply_tb(resume_id, jobs_id, is_pass, created_at) values(3,1,'대기중',now());
insert into apply_tb(resume_id, jobs_id, is_pass, created_at) values(5,1,'대기중',now());
insert into apply_tb(resume_id, jobs_id, is_pass, created_at) values(6,1,'대기중',now());
insert into apply_tb(resume_id, jobs_id, is_pass, created_at) values(2,3,'대기중',now());
